...
bool tf2_web_republisher_interfaces__msg__tf_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tf2_web_republisher_interfaces.msg._tf_array.TFArray", full_classname_dest, 52) == 0);
  }
  tf2_web_republisher_interfaces__msg__TFArray * ros_message = _ros_message;
  {  // transforms
...
PyObject * tf2_web_republisher_interfaces__msg__tf_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tf2_web_republisher_interfaces.msg._tf_array");
